...
TessellationFactors HullConstant(InputPatch<VertexControl, 3> v)
{
	TessellationFactors output;
	float4 tf = 1;

	tf = DistanceBasedTess(v[0].positionOS, v[1].positionOS, v[2].positionOS, _TessValue, _TessMin, _TessMax, _WorldSpaceCameraPos);
